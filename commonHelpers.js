import{S as k,i as u,a as $}from"./assets/vendor-bad0427b.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function e(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerpolicy&&(r.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?r.credentials="include":t.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(t){if(t.ep)return;t.ep=!0;const r=e(t);fetch(t.href,r)}})();const B="/goit-js-hw-12/assets/error-cc3a3fd7.svg",C="/goit-js-hw-12/assets/notification-0ba76ce7.svg",y=document.querySelector(".searching-form"),a=document.querySelector(".button"),m=document.querySelector(".load-more-btn"),h=document.querySelector(".gallery"),I=document.querySelector(".container"),i={title:"",iconUrl:`${B}`,backgroundColor:"#EF4040",titleColor:"#fff",messageColor:"#fff",theme:"dark",messageSize:"16px",progressBarColor:"#B5EA7C",position:"topRight"},g=40;let l=1,p,f,c,M=new k(".gallery a",{captionsData:"alt",captionDelay:250,className:"lightbox-on"});y.addEventListener("submit",E);async function E(o){o.preventDefault(),v(),h.innerHTML="",l=1,q();const s=o.currentTarget.elements.searching.value.trim();p=encodeURIComponent(s),console.log(p);try{const e=await b(),n=e.totalHits;if(n===0)throw new Error("There are no images matching your search query. Please try again!");c=e.hits,w(c),document.addEventListener("scroll",O),n>g&&(T(),m.addEventListener("click",L))}catch(e){u.error(i,i.message=`Sorry! ${e.message}`)}finally{S()}}async function b(){return f={params:{key:"41547319-253ef689baf3db6007ef0d5b5",q:`${p}`,orientation:"horizontal",per_page:g,page:l,image_type:"photo",safesearch:!0,order:"likes"}},(await $.get("https://pixabay.com/api/",f)).data}async function L(){q(),l+=1;try{const o=await b(),s=o.totalHits,e=Math.ceil(s/g);l===e&&(removeEventListener("click",L),v(),u.info(i,i.iconUrl=`${C}`,i.message="We're sorry, but you've reached the end of search results.",i.backgroundColor="#0ab6f5")),c=o.hits,w(c),P()}catch(o){u.error(i,i.message=`Sorry! ${o.message}`)}finally{S()}}function w(o){const s=o.map(e=>`<li class="gallery-item"><div class='image-wrapper'>
